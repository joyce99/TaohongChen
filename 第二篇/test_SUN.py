...
wandb.init(project='VIT-ZSL',config='wandb_config/sun_zslvit.yaml')
args = wandb.config
...
if args.gzsl:
   checkpoint = torch.load('/home/admin/chenshiming/hwj/ViT-ZSL/saved_model/ZSLViT_SUN_GZSL.pth',map_location=torch.device('cpu'))
else:
   checkpoint = torch.load('/home/admin/chenshiming/hwj/ZSLVIT/saved_model/ZSLViT_SUN_CZSL.pth',map_location=torch.device('cpu'))
