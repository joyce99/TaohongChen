...
wandb.init(project='ZSLVIT',config='wandb_config/cub_gzsl_train.yaml')  #VIT-ZSL
args = wandb.config
...
if DATASET == 'AWA2':
  ...
  ROOT='F:/cvpr20_DAZLE/data/CUB/CUB_200_2011/images/'#'./data/CUB/CUB_200_2011/CUB_200_2011/images/'
elif DATASET == 'SUN':
