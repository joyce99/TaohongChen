...
wandb.init(project='VIT-ZSL',config='wandb_config/cub_zslvit.yaml')
args = wandb.config
...
if DATASET == 'AWA2':
  ...
  ROOT='F:/cvpr20_DAZLE/data/CUB/CUB_200_2011/images/'
elif DATASET == 'SUN':
...
if args.gzsl:
   checkpoint = torch.load('./saved_model/ZSLViT_CUB_GZSL.pth',map_location=torch.device('cpu'))
else:
